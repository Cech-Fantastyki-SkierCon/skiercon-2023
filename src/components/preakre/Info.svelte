    ...
    <div>
      ...
      {#if $preakreForm.transportHelp}
        <p class="mt-4">
          ...
          adres <a href="mailto:dostepnosc@skiercon.pl" class="link link-info">
...
<!-- <div class="wysiwyg">
  <p>
    Jeśli planujesz być Twórcą Programu, zwróć uwagę, żeby podać ten sam adres
    e-mail co w zgłoszeniu punktu programu lub sesji RPG. W oparciu o e-mail
