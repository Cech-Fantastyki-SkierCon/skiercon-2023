...
<div class="form-control mt-4">
  <label class="label cursor-pointer items-start justify-start">
    ...
    <div>
      ...
      <p>
        Wysokiej jakości czarny t-shirt unisex, 100% bawełna, gramatura 200g/m²,
        nadruk z&nbsp;przodu. <a
...
<div class="form-control mt-4">
  <label class="label cursor-pointer items-start justify-start">
    ...
    <div>
      ...
      <p class="">
        Chcemy oszczędzać papier i&nbsp;nie produkować niepotrzebnej makulatury,
        dlatego wydrukujemy tylko tyle informatorów konwentowych, ile zostanie
        zamówionych przez uczestników. Dla każdego dostępny będzie informator
        w&nbsp;wersji elektronicznej oraz w&nbsp;<a
